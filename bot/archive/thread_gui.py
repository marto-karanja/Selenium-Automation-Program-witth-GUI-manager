...
class MyFrame(wx.Frame):
    def __init__(self):
        ...
        self.bot_delay_combo = wx.ComboBox(panel, -1, "Choose Delay in Seconds", (15, 30), (150,25), delay, wx.CB_DROPDOWN)
        bot_choices = {'1 Bidder':'1', '2 Bidders': '2','3 Bidders': '3', '4 Bidders': '4', '5 Bidders':'5', '6 Bidders': '6'}
        self.bot_bidder_combo = wx.ComboBox(panel, -1, "Choose No. Of Bidders", (15, 30), (150,25), list(bot_choices.keys()), wx.CB_DROPDOWN)
        ...
        # Add second row
        inner_2 = wx.BoxSizer(wx.HORIZONTAL)
        inner_2.Add(self.bot_delay_combo,0, wx.RIGHT,15)
        inner_2.Add(self.bot_bidder_combo,0, wx.RIGHT,15)
        # Add third row for progress bar
        inner_3 = wx.BoxSizer(wx.VERTICAL)
        inner_3.Add(self.progress_bar,0, wx.ALL|wx.EXPAND, 5)
        
        main = wx.BoxSizer(wx.VERTICAL)
        main.Add(inner, 0, wx.ALL, 5)
        main.Add(inner_2, 0, wx.ALL, 5)
        main.Add(inner_3, 0, wx.EXPAND|wx.ALL, 5)
