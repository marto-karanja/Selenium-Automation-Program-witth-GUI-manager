...
class SketchFrame(wx.Frame):
    ...
    def createSimpleTool(self, toolbar, label, filename, help, handler):
        ...
        tool = toolbar.AddTool( -1, label=label, bitmap = bmp, shortHelp="", kind=wx.ITEM_NORMAL)
    ...
    def createColorTool(self, toolbar, color):
        ...
        tool = toolbar.AddRadioTool(-1, label="", bitmap1 =  bmp, shortHelp=color)
